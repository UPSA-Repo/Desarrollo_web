...
const Modificar_Cliente = gql `
    mutation ModificarCliente($id: ID, $input: ClienteInput) {
      modificarCliente(id: $id, input: $input) {
        id
        nombre
        direccion
        telefono
...
const ModificarCliente = () => {
    ...
    const [ modificarCliente ] = useMutation(Modificar_Cliente)
    ...
    const formik = useFormik({
        ...
        onSubmit: async valores => {
            ...
            const { id, nombre, direccion, telefono, tipo } = valores

            try {

                const { data } = await modificarCliente ({
                    variables: {
                        id,
                        input: {
                            nombre,
                ...
                guardarMensaje(`El cliente fue modificado correctamente.`)
    ...
    return (
        <>
            <LayoutCliente>
                ...
                <h1 className="text-2xl text-gray-200 font-light">Modificar Cliente</h1>
