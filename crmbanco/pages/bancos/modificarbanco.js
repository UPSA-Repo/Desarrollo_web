...
const Modificar_Banco = gql `
    mutation ModificarBanco($input: BancoInput, $id: ID) {
      modificarBanco(input: $input, id: $id) {
        id
        nombre
      }
    }
...
const ModificarBanco = () => {

    const [mensaje, guardarMensaje] = useState(null)

    const [ modificarBanco ] = useMutation(Modificar_Banco)
    ...
    const formik = useFormik({
        ...
        onSubmit: async valores => {
            ...
            try {
                ...
                const { data } = await modificarBanco ({
                    variables: {
                        id,
                        input: {
                            nombre
                ...
                guardarMensaje(`El Banco fue modificado correctamente.`)
    ...
    return (
        <>
            <LayoutBanco>
                ...
                <h1 className="text-2xl text-gray-200 font-light">Modificar Banco</h1>
