...
const NuevaCuenta = ()=> {
    ...
    //State para el mensaje (Mensaje de que está correcto o que tiene un error.
    ...
    const formik = useFormik({
        ...
        onSubmit: async valores => {
            ...
            try {
                ...
                console.log( data );
                //Usuario creado corréctamente
                guardarMensaje(`El usuario ${data.nuevoUsuario.nombre} fue creado correctamente.`);
                setTimeout(()=> {
                    guardarMensaje(null);
    ...
    return (
        <>
            <Layout>
                ...
                <h1 className="text-center">Cear Nueva Cuenta</h1>
